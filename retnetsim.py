import random
from embretnet.netop import Network
from embretnet.treeop import Node, Tree, str2tree, getlabs
import subprocess
...
def simulate(leaves, ret):
    process = subprocess.Popen(["Rscript", "treesim.r", "-l", str(leaves)], stdout=subprocess.PIPE)
